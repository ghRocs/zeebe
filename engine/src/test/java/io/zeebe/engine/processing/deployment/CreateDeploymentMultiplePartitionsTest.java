...
public final class CreateDeploymentMultiplePartitionsTest {
  ...
  public void shouldIncrementProcessVersions() {
    ...
    var deployedProcesss = firstCreatedDeployment.getValue().getDeployedProcesss();
    assertThat(deployedProcesss).flatExtracting(DeployedProcess::getVersion).containsOnly(1);
    ...
    deployedProcesss = secondCreatedDeployments.getValue().getDeployedProcesss();
    assertThat(deployedProcesss).flatExtracting(DeployedProcess::getVersion).containsOnly(2);
  }
