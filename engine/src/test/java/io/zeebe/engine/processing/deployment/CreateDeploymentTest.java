...
public final class CreateDeploymentTest {
  ...
  public void shouldWriteProcessRecordsOnDeployment() {
    ...
    final var processKeyList =
        deployment.getDeployedProcesss().stream()
    ...
    final var firstProcessRecord =
        RecordingExporter.processRecords().withBpmnProcessId(PROCESS_ID).getFirst();
    ...
    final var secondProcessRecord =
        RecordingExporter.processRecords().withBpmnProcessId(PROCESS_ID_2).getFirst();
